...
Namespace SignPDFWithHardwareCertificate
  ...
  Friend Class Program
    ...
    Private Shared Function GetCertificate() As X509Certificate2
      ...
      Dim selectedCertificates As X509Certificate2Collection =
            X509Certificate2UI.SelectFromCollection(store.Certificates, Nothing, Nothing, X509SelectionFlag.SingleSelection)
